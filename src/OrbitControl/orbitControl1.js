...
export default function OrbitControl1 () {

  let scene, camera, renderer,geometry,  material, cube1, cube2, plane, sphere, directionalLightUp, directionalLightDown, target, spotLight, control
